...
data_path=/media/disk_a/ICARUS/PMT/Data201905
...
#run python script
LD_LIBRARY_PATH=/cvmfs/sft.cern.ch/lcg/app/releases/ROOT/6.16.00/x86_64-ubuntu18-gcc73-opt/lib/ PYTHONPATH=/cvmfs/sft.cern.ch/lcg/app/releases/ROOT/6.16.00/x86_64-ubuntu18-gcc73-opt/lib python PreprocessData.py $dirDataName > ${dirDataName}_output.txt

#print message if successful
echo "$dirDataName.root created and analysis performed"
