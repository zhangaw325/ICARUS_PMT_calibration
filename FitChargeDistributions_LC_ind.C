...
void FitChargeDistributions_LC_ind(string pmtRow,
					     ...
					     int volt1, int volt2, int volt3, bool led, int pmt){
  ...
  */
  ...
  resultnames[pmt]  = strchimney + strpmt + "CH" + channelnames[pmt] + "_"
    + "Led" + ledstr + "_lowcharge.pdf";
  cout << resultnames[pmt] <<endl;
  ...
  initparam[pmt]="chID\t"+to_string(pmt)+"\t"       //channel id
